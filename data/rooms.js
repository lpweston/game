...
exports.hanger1Template = {
  ...
  options: {
    ...
    "Search Lockers":
      "The lockers contain spacesuits, with limbs and bodily proportions strange and surprising to you. Whoever operates this ship does not resemble you in the slightest. One of the spacesuits has a pouch on the front which contains an ID card, which you take (+1 ID Card 1)"
  },
  doors: {
    "Central Corridor Door": {
      status: "closed",
      key: "repressurised central corridor",
      closed:
